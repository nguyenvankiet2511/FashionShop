...
if __name__ == '__main__':
    with app.app_context():
        ...
        # #
        # categories_data = [
        #     Categories(name='Áo sơ mi'),
        #     Categories(name='Quần jeans'),
        #     Categories(name='Áo khoác'),
        #     Categories(name='Giày thể thao'),
        #     Categories(name='Phụ kiện thời trang')
        # ]
        ...
        # db.session.commit()
        cart_data = [
            Carts(customer_id=6, product_id=63, quantity=2, price=200.00, discount=10),
            Carts(customer_id=7, product_id=73, quantity=1, price=150.00, discount=5),
            Carts(customer_id=6, product_id=65, quantity=3, price=100.00, discount=15),
            Carts(customer_id=6, product_id=74, quantity=4, price=250.00, discount=20),
            Carts(customer_id=6, product_id=77, quantity=2, price=300.00, discount=25),
            Carts(customer_id=7, product_id=82, quantity=1, price=350.00, discount=30),
            Carts(customer_id=7, product_id=83, quantity=5, price=400.00, discount=35),
            Carts(customer_id=7, product_id=68, quantity=3, price=450.00, discount=40),
            Carts(customer_id=6, product_id=70, quantity=2, price=500.00, discount=45),
            Carts(customer_id=7, product_id=80, quantity=1, price=550.00, discount=50)
        ]
